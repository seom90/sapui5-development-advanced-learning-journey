		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#studentseomcomsaptrainingux402listdetailux402listdetail-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"studentseomcomsaptrainingux402listdetailux402listdetail-display": {
								"semanticObject": "studentseomcomsaptrainingux402listdetailux402listdetail",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=studentseom.com.sap.training.ux402.listdetail.ux402listdetail",
									"url": sap.ui.require.toUrl("studentseom/com/sap/training/ux402/listdetail/ux402listdetail")
								}
							}
						}
					}
